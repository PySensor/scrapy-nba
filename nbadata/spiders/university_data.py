...
class PlayerUniversitySpider(scrapy.Spider):
    name = 'university'
    ...
    start_urls = [
        "http://stats.nba.com/stats/playercareerstats?LeagueID=00&PlayerID={}&PerMode=PerGame".format(i)
    ...
    def parse(self, response):
        ...
        for datas in content[6:7]:
            try:
                for data in datas['rowSet']:
                    item = PlayerDataItem()
                    item['PLAYER_NAME'] = PlayerUniversitySpider.player_dict[data[0]]
